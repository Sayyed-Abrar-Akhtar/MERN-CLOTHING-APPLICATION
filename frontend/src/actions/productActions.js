...
export const listProducts = (keyword = '', pageNumber = '') => async (
  ...
  try {
    ...
    const { data } = await axios.get(
      `/api/products/paginated?keyword=${keyword}&pageNumber=${pageNumber}`
    );
...
export const updateProduct = (productupdated) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    const {
      ...
      `/api/products/${productupdated._id}`,
      productupdated,
      config
    );
